...
const Settings = () => {
  ...
  // Move useEffect outside of Formik
  useEffect(() => {
    if (currentRecord) {
      console.log('Current record updated:', currentRecord);
      setFormValues({
        recordId: currentRecord.id || '',
        recordName: currentRecord.metadata.name || '',
        recordDescription: currentRecord.metadata.description || '',
        recordTags: Array.isArray(currentRecord.metadata.tags) ? currentRecord.metadata.tags.join(', ') : '',
        recordInstructions: Array.isArray(currentRecord.metadata.instructions) ? currentRecord.metadata.instructions.join('\n') : ''
      });
